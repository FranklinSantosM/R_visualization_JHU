...
```{r, problems2}
my_dat <- tibble(alpha=1:5, beta=6:10)
```
...
boxplot(dat$faminc_new,
        main="Franklin's Boxplot of Family Income", ###add main title
...
datfilter <- filter(dat, gender == 1, region == 1 | region == 2, marstat == 1, newsint == 1)
str(datfilter)
```
